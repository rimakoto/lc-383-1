...
export const imageSets: ImageSet[] = [
  {
    ...
    differences: [
      { id: 1, x: 81.25, y: 16.67, radius: 6 },
      { id: 2, x: 8.75, y: 76.67, radius: 6 },
      { id: 3, x: 21.25, y: 73.33, radius: 5.5 },
      { id: 4, x: 75, y: 76.67, radius: 5 },
      { id: 5, x: 51.25, y: 90, radius: 5 },
    ],
  },
  {
    id: generateId(),
    ...
    differences: [
      { id: 1, x: 15, y: 30.83, radius: 8 },
      { id: 2, x: 78.13, y: 16.67, radius: 4 },
      { id: 3, x: 25, y: 45.83, radius: 4 },
      { id: 4, x: 62.5, y: 48.33, radius: 6 },
      { id: 5, x: 85, y: 49.17, radius: 5 },
    ],
  },
  {
    id: generateId(),
    ...
    differences: [
      { id: 1, x: 87.5, y: 15, radius: 5.5 },
      { id: 2, x: 51.88, y: 51.67, radius: 4 },
      { id: 3, x: 18.75, y: 73.33, radius: 6 },
      { id: 4, x: 68.75, y: 78.33, radius: 6 },
      { id: 5, x: 58.13, y: 66.67, radius: 5.5 },
    ],
  },
  {
    id: generateId(),
    ...
    differences: [
      { id: 1, x: 50, y: 15.83, radius: 5.5 },
      { id: 2, x: 16.25, y: 15.83, radius: 4 },
      { id: 3, x: 50, y: 45, radius: 8 },
      { id: 4, x: 68.75, y: 58.33, radius: 6 },
      { id: 5, x: 85, y: 29.67, radius: 2.5 },
    ],
  },
];
